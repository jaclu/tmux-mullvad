...
`@mullvad_disconnected_fg_color`   |  | color
`@mullvad_disconnected_bg_color`   | red | color
`@mullvad_blocked_text`            | open padlock icon   | Status
`@mullvad_blocked_fg_color`        | | color
`@mullvad_blocked_bg_color`        | purple | color
`@mullvad_connecting_text`         | closed padlock icon | Status
`@mullvad_connecting_fg_color`     | | coloe
`@mullvad_connecting_bg_color`     |yellow|color
`@mullvad_connected_text`          | closed padlock icon with key on the side | Status
`@mullvad_connected_fg_color`      ||color
`@mullvad_connected_bg_color`      |green| color
...
The best way to send feedback is to file an issue at [issues](https://github.com/jaclu/tmux-mullvad/issues) for this repo.
